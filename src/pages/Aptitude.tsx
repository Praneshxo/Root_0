        ...
        <div className="px-6 py-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-[#A0A0B0]">Practice aptitude questions to improve your problem-solving skills and prepare for aptitude tests</p>
            </div>
          </div>
            ...
            <tbody>
              {loading ? (
                ...
                filteredQuestions.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((question, index) => (
                  <tr
                    key={question.id}
                    onClick={() => navigate(`/aptitude/${question.id}`)}
