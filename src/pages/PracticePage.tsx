    ...
    <div className="space-y-6">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-800">
                ...
                <th className="text-left p-4 text-sm font-medium text-gray-400">Problem Title</th>
                  ...
                  >
                    <td className="p-4">
                      {isSolved ? (
                        ...
                        <Circle className="w-5 h-5 text-gray-600 cursor-pointer hover:text-gray-500" />
                      )}
                    </td>
                    <td className="p-4">
      ...
      {selectedQuestion && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="p-6 bg-gray-900/50">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 text-white text-sm font-medium rounded-lg transition-all"
                    >
                  ...
                  {showSolution ? (
                    ...
                    <div className="bg-gray-800/30 border-2 border-dashed border-gray-700 rounded-lg p-8 text-center">
